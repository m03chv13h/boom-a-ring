...
//! show/hide is managed by BellDataField itself, and the lap button triggers
//! the bell via DataField.onTimerLap().
//!
//! Note: Key events (onKeyPressed/onKeyReleased) are NOT routed to data-field
//! delegates on non-touch devices, so button handling is done in BellDataField.
